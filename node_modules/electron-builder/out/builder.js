...
function publishManager(packager, publishTasks, options, isPublishOptionGuessed) {
    ...
    packager.artifactCreated(event => {
        ...
        for (let publishConfig of util_1.asArray(publishers)) {
...
function createPublisher(packager, options, publishConfig) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (publishConfig.provider === "github") {
            ...
            log_1.log(`Creating Github Publisher — user: ${ user }, project: ${ repo }, version: ${ version }`);
            return new gitHubPublisher_1.GitHubPublisher(user, repo, version, options, isPublishOptionGuessed, config);
        }
